...
export const createStaff = {
  body: Joi.object().keys({
    ...
    academicQualification: Joi.string().valid('NCE', 'B.Ed', 'B.Sc', 'HND', 'PGDE', 'SSCE').optional().allow(null, ''),
    trcnRegistered: Joi.boolean().optional().allow(null),
    salarySource: Joi.string().valid('1-FTS', '2-SUBEB', '3-Private').optional().allow(null, ''),
...
export const updateStaff = {
  ...
  body: Joi.object()
    .keys({
      ...
      academicQualification: Joi.string().valid('NCE', 'B.Ed', 'B.Sc', 'HND', 'PGDE', 'SSCE').allow(null, ''),
      trcnRegistered: Joi.boolean().allow(null),
      salarySource: Joi.string().valid('1-FTS', '2-SUBEB', '3-Private').allow(null, ''),
      employmentType: Joi.string().valid('teacher', 'staff'),
      isActive: Joi.boolean(),
    })
    .min(1),

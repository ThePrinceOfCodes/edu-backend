...
export const createSchool = async (schoolBody: CreateSchoolPayload, actor: IUserDoc) => {
  ...
  const school = await School.create({
    ...
    schoolCode: schoolBody.schoolCode,
    state: schoolBody.state,
    localGovernment: schoolBody.localGovernment,
    district: schoolBody.district,
    ward: schoolBody.ward,
    schoolLocation: schoolBody.schoolLocation,
    categoryOfSchool: schoolBody.categoryOfSchool,
    accessRoadCondition: schoolBody.accessRoadCondition,
    typeOfSchool: schoolBody.typeOfSchool,
    shiftSystem: schoolBody.shiftSystem,
    facilitiesAvailable: schoolBody.facilitiesAvailable,
    headTeacherName: schoolBody.headTeacherName,
    headTeacherPhoneNumber: schoolBody.headTeacherPhoneNumber,
    assistantHeadTeacherName: schoolBody.assistantHeadTeacherName,
    assistantHeadTeacherPhoneNumber: schoolBody.assistantHeadTeacherPhoneNumber,
    longitude: schoolBody.longitude,
    latitude: schoolBody.latitude,
    numberOfClasses: schoolBody.numberOfClasses,
    numberOfClassroomsAvailable: schoolBody.numberOfClassroomsAvailable,
    numberOfAcademicStaff: schoolBody.numberOfAcademicStaff,
    numberOfNonAcademicStaff: schoolBody.numberOfNonAcademicStaff,
    totalEnrolledStudents: schoolBody.totalEnrolledStudents,
    gallery: schoolBody.gallery,

...
const schoolValidation = __importStar(require("../../modules/school/school.validation"));
const schoolController = __importStar(require("../../modules/school/school.controller"));
...
router
    ...
    .patch(auth_1.authenticate, (0, auth_1.authorize)('schools.write'), (0, validate_middleware_1.default)(schoolValidation.updateSchool), schoolController.updateSchool)
    .delete(auth_1.authenticate, (0, auth_1.authorize)('schools.write'), (0, validate_middleware_1.default)(schoolValidation.deleteSchool), schoolController.deleteSchool);

...
exports.zipMarksToWorkingDays = exports.getWorkingDays = void 0;
/**
 ...
 */
const zipMarksToWorkingDays = (workingDays, statusMarks) => {
    return statusMarks
        .map((rawMark, i) => (workingDays[i] ? { date: workingDays[i], rawMark } : null))
        .filter((entry) => entry !== null);
};
exports.zipMarksToWorkingDays = zipMarksToWorkingDays;
//# sourceMappingURL=attendant-dates.util.js.map
...
exports.AttendanceExtractionSchema = zod_1.z.object({
    ...
    students: zod_1.z.array(zod_1.z.object({
        ...
        attendance: zod_1.z.object({
            week_1: exports.AttendanceWeekStringSchema,
            week_2: exports.AttendanceWeekStringSchema,
            week_3: exports.AttendanceWeekStringSchema,
            week_4: exports.AttendanceWeekStringSchema,
            week_5: exports.AttendanceWeekStringSchema,
        }),

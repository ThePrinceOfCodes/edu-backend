...
mongoose_1.default.connect(config_1.default.mongoose.url).then(async () => {
    logger_1.default.info('Connected to MongoDB');
    if (config_1.default.internalAdminSeed.enabled) {
        await (0, user_seed_1.seedInternalAdminUser)({ requireConfig: true });
    }
